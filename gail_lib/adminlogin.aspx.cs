    ...
    public partial class adminlogin : System.Web.UI.Page
    {
        ...
        protected void login_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                OracleCommand com = new OracleCommand("SELECT * FROM admins WHERE adminid='" + TextBox1.Text.Trim() + "' AND password='" + TextBox2.Text.Trim() + "'", con);
                ...
                if (odr.HasRows)
                {
                    while (odr.Read())
                    {
                        ...
                        Session["role"] = "admin";
                        Session["adminid"] = odr.GetValue(0).ToString();
