<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="gail_lib.userprofile" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col-6">
                        <center>
                           <img width="50px" src="img/man.png"/>
                            <h4>Your Profile</h4>
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <center>
                           <div class="form-group">
                              <asp:Button class="btn btn-primary  btn-sm mt-2" ID="Button1" runat="server" Text="Update" />
                           </div>
                        </center>
                     </div>
                  </div>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="50px" src="img/book.png"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
